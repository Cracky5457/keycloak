...
public interface RolesResource {
    ...
    /**
     * @param fullRepresentation if true, return roles with their attributes
     * @return A list containing all roles.
     */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    List<RoleRepresentation> list(@QueryParam("full") @DefaultValue("false") boolean fullRepresentation);
